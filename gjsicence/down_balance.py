...
from server.models import Stock, FinancialStatement, IncomeStatement, CashFlowStatement, BalanceStatement
...
for date in date_list:
	...
	for stock in stock_list:
		...
		time.sleep(1.2)
		df = pro.balancesheet(ts_code=stock.symbol+exchange, period=date)
